...
import cn.nurasoft.wheelmultipicker.R;
...
public class WheelPicker extends View implements IWheelPicker, Runnable {
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        mData = Arrays.asList(getResources().getStringArray(idData == 0 ? R.array.chinese_week_string_array : idData));
    ...
    protected void onSizeChanged(int w, int h, int oldW, int oldH) {
      ...
      //  mHalfItemHeight = mItemHeight / 2;
        mItemHeight=mRectDrawn.height()/3;
        mHalfItemHeight=mItemHeight/2;
...
//                mRectDrawn.right, indicatorFootCenterY + halfIndicatorSize);
        mRectIndicatorHead.set(mRectDrawn.left,0,mRectDrawn.right,0);
        mRectIndicatorFoot.set(mRectDrawn.left,0,mRectDrawn.right,0);
    }
